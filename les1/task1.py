...
def check_2(lst_obj):
    ...
    Сложность: !!!.
    """
    for j in range(len(lst_obj)):          # константная
        if lst_obj[j] in lst_obj[j+1:]:    # линейно-лагорифмическая
...
def check_3(lst_obj):
    ...
    for i in range(len(lst_obj) - 1):        # константная
        if lst_copy[i] == lst_copy[i+1]:     # линейно-лагорифмическая
            return False                     # константная
    return True                              # константная
